...
func GetConfigEnv() (*Config, error) {
	cfg := &Config{
		...
		MiddlewareInternalIP:   os.Getenv("MIDDLEWARE_INTERNAL_IP"),
		...
		// RabbitMQ
		// RabbitGlobalURL:      os.Getenv("RABBITMQ_GLOBAL_URL"),
		ExchangeName:         "events",
    ...
    cfg.RabbitGlobalURL = os.Getenv("RABBITMQ_GLOBAL_URL")
...
func (cfg *Config) Validate() error {
	...
	if cfg.RabbitGlobalURL == "" {
		return fmt.Errorf("missing RabbitMQ URLs")
	}
	return nil
}
